...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-row grow ">
      ...
      {smallLayout && (
        <div className="w-1/2 gap-7 pr-4 md:pr-10 lg:pr-52 h-full flex flex-col justify-center">
      ...
      {!smallLayout && (
        <div className="w-full gap-7 px-4 h-full flex flex-col justify-center">
          <h1 className="headings-h1">Login</h1>
